    ...
    def _handle_PacketIn(self, event):
        ...
        # IP
            ...
            if routable:
                ...
                # if the packet ip_packet is an ipv4.ICMP_PROTOCOL
                ...
                # else  is for one of the networks
                    ...
                    if destination_ip not in self.arp_table:
                        ...
                        self.buffer[destination_ip] = {'IP_Packet': ip_packet,
                        ...
                        arpRequest.protosrc = IPAddr(self.routing_table[str(destination_network)]['RouterInterface'])
                        ...
                        # set the 'hwdst' var of your arp object to an all zeros mac address '00:00:00:00:00:00'
                        # NOTE: you can use the method EthAddr('00:00:00:00:00:00') to pasrse a string to an MAC addr.
                        arpRequest.hwsrc = EthAddr(self.arp_table[self.routing_table[destination_network]['RouterInterface']])
                        arpRequest.hwdst = EthAddr('00:00:00:00:00:00')
                        # Construct the ethernet frame
                        ether = ethernet()
                        ether.type = ethernet.ARP_TYPE #--- defines that this frame carries a ARP type message
                        ...
                        ether.src = EthAddr(self.arp_table[self.routing_table[destination_network]['RouterInterface']]) # mac address of the outgoing router interface
