...
http.createServer(function(req,res){
    ...
    if(req.method == 'GET'){
        if(req.url == '/'){
            ...
            var aluno_id =/[0-9]+/.exec(split)
            axios.get('http://localhost:3001/alunos/A'+aluno_id)
                .then(function (resp){
                    aluno = resp.data
                    res.writeHead(200,{'Content-Type': 'text/html; charset=utf-8'})
                    res.write('<h3>Escola de Música: '+ aluno.nome + '</h3>')
                    res.write('<ul>')
            ...
            .catch(function(error){
                ...
                axios.get('http://localhost:3001/cursos/'+ reg_curso)
                    .then(function (resp){
                        curso = resp.data
                        res.writeHead(200,{'Content-Type': 'text/html; charset=utf-8'})
                        ...
                        res.write('<li>'+ 'ID do Instrumento :  ' + curso.instrumento.id + '</li>')
            ...
            axios.get('http://localhost:3001/instrumentos/I'+ ins_id )
                .then(function (resp){
